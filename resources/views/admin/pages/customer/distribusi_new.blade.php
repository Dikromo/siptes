            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ $title }} Campaign</h3>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <form action="/customer/distribusi/prosesnew" id="formDistribusi" method="POST">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="form-group">
                                <label for="fileexcel_id">Kode</label>
                                <select multiple name="fileexcel_id[]"
                                    class="form-control select2 @error('fileexcel_id') is-invalid @enderror  "
                                    id="fileexcel_id" required>
                                    @if (session('oldData') != '')
                            ...
                            <div class="form-group">
                                ...
                                TELEMARKETING<br>
                                @error('cbox_filter')
                                    <span id="cbox_filter" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <?php
    ...
    <script>
        ...
        function dataTablesfrom(select) {
            ...
            $('#dataTables1').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: '/customer/ajax/fromnew',
                    data: {
                        _token: '{{ csrf_token() }}',
                        produk_id: $("#produk_id").val(),
                        fileexcel_id: $("#fileexcel_id").val(),
                        rbox_filter: $("input[name='rbox_filter']:checked").val(),
                        provider: $("#provider").val(),
                        tipe: $("#tipe").val(),
                        user_id: $("#user_id").val(),
                    }
                },
                columns: $paramColumnfrom
            });
